...
with Diagram("Healthcare Document Classification System V4", show=False):
    # External Sources
    ...
    with Cluster("Queue Management"):
        ...
        retry_queue = SQS("Dead Letter Queue ( Retry Queue )")
    ...
    [batch_queue, priority_queue, standard_queue] >> retry_queue
    
    # LLM processing flow
    [batch_queue, priority_queue, standard_queue, retry_queue] >> llm_api
